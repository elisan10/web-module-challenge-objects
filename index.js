...
*/
console.log(createMenuItem('enchiladas', 6, 'dinner'))
console.log(createMenuItem('ice cream cone', 2, 'dessert'))
...
*/
reviews.push({name: "Elizabeth", rating: 2.5, feedback: "It was alright"})
console.log(reviews)
